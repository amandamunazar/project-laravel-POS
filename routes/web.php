...
Route::group(['prefix' => 'super', 'middleware' => ['role:SU']], function () {
    Route::get('home', [DashboardController::class, 'super'])->name('dashboard.super');
});

Route::group(['prefix' => 'admin', 'middleware' => ['role:AD']], function () {

Route::get('home', [DashboardController::class, 'admin'])->name('dashboard.admin');
